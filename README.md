...
| 💬 **Telegram (личный аккаунт)** | Полноценный доступ к вашему собственному Telegram через MTProto (не бот): непрочитанные, чтение истории и медиа, отправка текста/файлов/голосовых от вашего имени; `jarvis telegram setup` один раз | `jarvis_telegram`, `plugins/jarvis-core/telegram_userbot.py`, `docs/TELEGRAM.md` |
